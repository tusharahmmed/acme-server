...
exports.mockLegalDocs = void 0;
exports.mockLegalDocs = [
    {
        id: '1',
...
Either party may terminate this agreement with cause immediately or without cause with 30 days notice.`,
        summary: 'Standard employment contract outlining position, compensation, confidentiality, and termination clauses for a senior software engineer role.',
...
Licensee shall comply with all applicable data protection laws including GDPR and CCPA when using the Software.`,
        summary: 'Software licensing agreement defining usage rights, restrictions, fees, warranties, and liability limitations for commercial software.',
...
Tenant may not assign or sublet without Landlord's prior written consent, which shall not be unreasonably withheld.`,
        summary: 'Commercial lease agreement for retail space covering rent, term, maintenance responsibilities, insurance, and tenant obligations.',
